...
def get_summary_structure_unionizes(mcc,injection_structure_ids):
    '''Get connectivity unionize records for injections in specified source structures for all default "Summary Structures"

    Same as get_structure_unionize for the predefined summary structures
