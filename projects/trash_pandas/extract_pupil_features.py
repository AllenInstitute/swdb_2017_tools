...
def extract_smooth_saccade_rate(dataset,sigma = 4):
    ...
    saccade_rate = instert_nans(diff_rate,idx_nonans)
...
def extract_smooth_pupil_rate(dataset,sigma = 4):
    ...
    pupil_area_rate = instert_nans(diff_area,idx_nonans)
    pupil_diameter_reate = instert_nans(diff_diameter,idx_nonans)
